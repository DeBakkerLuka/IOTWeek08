...
{
    public static class GetMoneyGainedByLocation
    {
        [FunctionName("GetMoneyGainedByLocation")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get",  Route = "money/{location}")] HttpRequest req, string location,
            ILogger log)
        {
            try
            {
